...
# environmental data
Ponds.env <- as.matrix(read.csv("/Users/ericanadolski/GitHub/TeamProject/Ponds.env.csv"))

nrow(Ponds.env) # number of sites
ncol(Ponds.env) # number of measurements
...
## Scatter plot of some env variables just to look at variation
...
# look at PCA of environmental data to see variation in site environments
...
Work with members of your Team Project to obtain reference sequences for taxa in your study. For microorganisms like the bacteria we worked with above, many people use the ribosomal gene (i.e., 16S rRNA). This has many desirable features, including it is relatively long, highly conserved, and identifies taxa with reasonable resolution. 
